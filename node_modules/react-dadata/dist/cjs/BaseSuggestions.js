...
var BaseSuggestions = /** @class */ (function (_super) {
    ...
    BaseSuggestions.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { role: "combobox", "aria-expanded": optionsExpanded ? 'true' : 'false', "aria-owns": this.uid, "aria-controls": this.uid, "aria-haspopup": "listbox", className: containerClassName || 'react-dadata react-dadata__container' },
            ...
            optionsExpanded && (react_1.default.createElement("ul", { id: this.uid, "aria-expanded": true, 
                ...
                suggestions.map(function (suggestion, index) {
                    ...
                    return (react_1.default.createElement("button", { role: "option", type: "button", "aria-selected": index === suggestionIndex ? 'true' : 'false', key: _this.getSuggestionKey(suggestion), onMouseDown: _this.onSuggestionClick.bind(_this, index), className: suggestionClass }, _this.renderOption(suggestion)));
                }))),
            children));
    };
