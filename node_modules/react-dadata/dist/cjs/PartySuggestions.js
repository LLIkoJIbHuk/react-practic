...
var PartySuggestions = /** @class */ (function (_super) {
    ...
    function PartySuggestions() {
        ...
        _this.renderOption = function (suggestion) {
            var _a;
            var _b = _this.props, renderOption = _b.renderOption, highlightClassName = _b.highlightClassName;
            var query = _this.state.query;
            return renderOption ? (renderOption(suggestion, query)) : (react_1.default.createElement("div", null,
                ...
                react_1.default.createElement("div", { className: "react-dadata__suggestion-subtitle" },
                    ...
                    ((_a = suggestion.data.address) === null || _a === void 0 ? void 0 : _a.value) && (react_1.default.createElement("div", { className: "react-dadata__suggestion-subtitle-item" },
