...
var HighlightWords = /** @class */ (function (_super) {
    ...
    HighlightWords.prototype.render = function () {
        ...
        var chunks = (0, highlight_words_1.default)({ text: text, query: query });
        return (react_1.default.createElement("span", { "aria-label": text }, chunks.map(function (chunk) {
            if (!chunk.match) {
                return (react_1.default.createElement("span", { key: chunk.key, "aria-hidden": true }, chunk.text));
            }
            var Component = tagName;
            return (react_1.default.createElement(Component, { key: chunk.key, className: highlightClassName, "aria-hidden": true }, chunk.text));
        })));
    };
